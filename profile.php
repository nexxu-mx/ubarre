            ...
            <section class="secti-on plso" style="background-color: #DFD5BE;">
                ...
                <div class="container p1" id="profile-inicio">
                    <div class="p6">
                        ...
                        <div class="p5">
                            <button class="p3" onclick="openCalendar()"><ion-icon name="checkbox-outline" aria-hidden="true" class="p2"></ion-icon>
                            ...
                            <button class="p3" onclick="openPerfil()"><ion-icon name="person-circle-outline" aria-hidden="true" class="p2"></ion-icon>
                                <p class="p4">Perfil</p>
                            </button>
                            <button class="p3" onclick="openPayment()"><ion-icon name="card-outline" aria-hidden="true" class="p2"></ion-icon>
                                <p class="p4">Medios de Pago</p>
                            </button>
                            <button class="p3" onclick="openPaquetes()"><ion-icon name="bag-outline" aria-hidden="true" class="p2"></ion-icon>
                                <p class="p4">Paquetes</p>
                            </button>
                            ...
                            <button class="p3" onclick="closeSession()"><ion-icon name="power" aria-hidden="true" class="p2"></ion-icon>
        ...
        <div class="modal-contentCal" id="modal-content">
            ...
            <div class="m2">
                <div class="m3">
                    ...
                    <h4 class="m6"><ion-icon name="time-outline" aria-hidden="true"></ion-icon>
