...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $descrip = trim($_POST['descrip_smoothie']);
    ...
    if ($idSmoothieEdit == 0) {
        ...
        $insertSmoothie = $conn->prepare("INSERT INTO smoothies (sabor, descrip) VALUES (?,?)");
        $insertSmoothie->bind_param("ss", $sabor, $descrip);
        ...
        $updateSmoothie = $conn->prepare("UPDATE smoothies SET sabor = ?, descrip = ? WHERE id = ?");
