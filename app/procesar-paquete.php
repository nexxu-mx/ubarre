...
if (
    ...
    $smoothiesPaquete = $smoothieCheck ? (int)trim($_POST['smoothies_paquete']) : "";
    ...
    if (isset($_POST['id_paquete_edit'])) {
        ...
        $updatePaquete->bind_param("sssssssssssi", $numeroClases, $costoPaquete, $nombrePaquete, $vigenciaPaquete, $invitadosPaquete, $personasPaquete, $descuento, $finalizadsc, $smoothieCheck, $smoothiesPaquete, $ilimitcheck, $idPaqueteEdit);
