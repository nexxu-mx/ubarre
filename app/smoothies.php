...
<body>
		...
		<div class="main-panel">
			...
			<div class="container">
                ...
                <div class="page-header">
						<h3 class="fw-bold mb-3">Smoothies</h3>
                    ...
                    <div id="curs">
					    	     <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                						...
                						<div class="ms-md-auto py-2 py-md-0">
                							<a href="alta-smoothie.php" class="btn btn-primary btn-round"><i class="fas fa-plus"></i> Nuevo</a>
                						</div>
                					</div>
        					    <div class="row" id="smoothies-list">
                                <!-- Los smoothies se cargarán aquí automáticamente -->
	...
	<script src="./assets/js/smoothies.js?v=<?php echo time(); ?>"></script>
