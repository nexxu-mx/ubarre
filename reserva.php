...
<body id="top">
    ...
    <main>
        <article>
            ...
            -->
                    <h1 style="color: var(--light-brown); margin-top: 60px">BOOK YOUR <span>Class</span></h1>
                    ...
                    <div class="white-container" style="box-shadow: 0 15px 12px 1px #0000004d;">
                        ...
                        <img class="logo-sencia-fin-reserva" src="assets/images/svg/logo-negro-sin-tagline.svg" alt="Logo Sencia">
                    </div>
                </div>
                </div>
            </section>
